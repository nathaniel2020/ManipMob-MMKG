...
def make_follower(args, vocab):
    ...
    if args.load_follower != '':
        ...
        agent.load(args.load_follower, load_scorer=(args.load_scorer == '' and scorer_exists))
...
def make_arg_parser():
    ...
    # parser.add_argument("--load_follower", type=str, default='/media/air/hard_2/VLN/20220716/experiments/03271456_org/snapshots/followersample2step_imagenet_mean_pooled_1heads_train_iter_14400val_unseen_sr_0.162')
    parser.add_argument("--feedback_method",
                        choices=["sample", "teacher", "sample1step", "sample2step", "sample3step", "teacher+sample",
                                 "recover"], default="teacher")
