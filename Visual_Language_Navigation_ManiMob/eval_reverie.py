...
usePano = True
# This means selecting one viewpoint as the next action
...
if __name__ == '__main__':
    ...
    env_result = json.load(
        open('experiments/l1.3/results/follower_pm_sample2step_imagenet_mean_pooled_1heads_val_unseen_iter_6400.json'))
